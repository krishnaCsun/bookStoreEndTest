...
public class Constants {
	...
	public final static String PROJECT_NAME = "Online Bookstore End to End Tests";
	...
	public final static String PROPERTY_FILE_PATH = WORKING_DIRECTORY + "/src/test/resources/test.properties";
